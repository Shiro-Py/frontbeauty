  ...
  return (
    ...
    >
      <View style={styles.inner}>
        <Text style={styles.title}>Войти как мастер</Text>
        <Text style={styles.subtitle}>Введите номер телефона для входа в BeautyGO Pro</Text>
        <TextInput
          style={styles.input}
          value={phone}
...
const styles = StyleSheet.create({
  ...
  input: {
    ...
    backgroundColor: '#fff', marginBottom: 24, letterSpacing: 1,
  },
  button: {
